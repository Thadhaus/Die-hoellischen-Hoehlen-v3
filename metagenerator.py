...
# (c) 2023 r.haerter@wut.de
#
import time
import random

items = [
    "rubys", "emeralds", "amethysts", "sapphires", "lapis lazulis", "beryls",
    "garnets"
]
...
def generate_description(my_room, roomname):
    sizes = [
        "tiny", "small", "dinky", "little", "shrimpy", "medium", "normal",
        "large", "very large", "huge", "giant"
    ]
    ...
    amounts = [
        "no ", "a few ", "some ", "scattered ", "occasional ", "many ",
        "lots of "
    ]
    #
    ...
    description = f"a {size} {room} with {amount}{thing}"
...
def generate_content(my_content, my_biom, roomname, my_description):
    ...
    if 'with no' in my_description:
        ...
        my_content[
            roomname] = '123456789 surprise'  # sollte nicht erreicht werden
        my_biom[roomname] = ""
    return True
...
def testprogramm():
    ...
    for raum in raumbeschreibung:
        print("Raum {}: {} mit {} und Biom {}".format(raum,
